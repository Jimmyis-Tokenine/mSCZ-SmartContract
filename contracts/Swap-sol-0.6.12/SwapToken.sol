...
contract SwapToken is Ownable {
    ...
    function swap(uint256 _amount, address _refaddr) public {
        ...
        if (_refaddr != address(0)) {
            require(tokenA.transfer(_refaddr, _payref), "transfer failed");
         }
    ...
    function ownerReclaim() public onlyOwner {
